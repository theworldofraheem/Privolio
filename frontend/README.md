...
Read-only code viewer (Monaco) 
View limit & expiration control 
Secure repo content preview    
Backend API (Node.js)          
...
Code Viewer:       Monaco Editor (VSCode in browser)
DB:                MongoDB (Mongoose)              
...
>>>>>>> 1f11cffb6264e9299e74701efacfe56fbd159a9c
